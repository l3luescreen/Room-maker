        ...
        <div class="row" style="background-color:#ABABBA;">
            ...
            <div class="col">
                ...
                <div class="row" style="text-align:left;">
                    <a href="#" style="font-size:20px;text-align:center;">
                        <p>
                            <br>
                    <button type="button" class="btn btn-info btn-lg" 
data-toggle="modal" data-target="#myteacher" 
style="font-family:Lucida Calligraphy, sans-serif;">ADD CONTACT</button>
                                </button>
                        </p>
                    </a>
                </div>
        ...
        <div class="row" style="background-color:#FFFFFF;padding-bottom:30px;">
            <div class="col-2" style="background-color:rgb(192, 169, 211);padding-bottom:30px;">
                ...
                <div class="row" style="padding-left:16px;">
                    ...
                    style="font-family:Lucida Calligraphy, sans-serif;">
                ...
                <?php
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                                    echo "<tbody><th>" . $row["name"]. "</th>";
                                    echo "<th>" . $row["surname"]. "</th>";
                                    echo "<th>" . $row["subject"]. "</th>";
                                    echo "<th>" . $row["numbers"]. "</th></tbody>";
                        }
                    } else {
                        echo "<h2>ไม่มีอาจารย์</h2>";
                    }
                    $conn->close();
                ?>
                </table>
...
class="btn btn-default">Submit</button>
        ...
        <div class="modal fade" id="myteacher" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
...
class="close" data-dismiss="modal">close</button>
                    ...
                    <form action="ddd.php" method="post">
                        <div class="modal-body">
                            <h1>เพิ่มอาจารย์</h1>
                            <input class="form-control" name="pokeone" type="text" placeholder="ชื่อ">
                            <input class="form-control" name="poketwo" type="text" placeholder="นามสกุล">
                            <input class="form-control" name="pokethree" type="text" placeholder="วิชาที่สอน">
                            <input class="form-control" name="pokefour" type="text" placeholder="เบอร์โทรศัพท์">
                        </div>
                        <div class="modal-footer">
                            <button type="submit" 
class="btn btn-default">Submit</button>
