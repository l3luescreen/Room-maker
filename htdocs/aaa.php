                            ...
                            echo"
                                <div class='card'>
                                    <div class='card-header'>
                                        <h2>วิชา: ".$row['mail_mail']."</h2>
                                    </div>
                                    <div class='card-body' 
                                    style='padding-top:0px;'>
                                        <h3>รายละเอียดงาน</h3>
                                        คะแนนเต็ม: ".$row['useruser']."<br>
                                        รายละเอียดงาน: ".$row['wordcodeword']."<br>
                                        <a href='".$row['wordcode']."'>ลิงค์เพิ่มเติม</a><br>
                                    </div>
                                    <div class='card-footer text-muted'>
                                        ประเภทงาน: ".$row['codeword']."
                                    </div>
                                </div>";
                        }
                    } else {
                        echo "<h2>ไม่มีการบ้าน</h2>";
                    }
                    $conn->close();
                ?>
